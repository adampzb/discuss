...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = [
            'id', 'email', 'first_name', 'last_name', 'bio', 'profile_picture', 'date_of_birth',
            'privacy_setting', 'email_notifications', 'push_notifications',
            'website', 'github_username', 'twitter_username', 'linkedin_username',
            'location', 'occupation', 'company', 'theme_preference', 'language_preference',
            'profile_background', 'followers_count', 'following_count', 'last_active', 'date_created'
        ]
        read_only_fields = ['id', 'last_active', 'date_created', 'followers_count', 'following_count']
...
class UserSearchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'email', 'first_name', 'last_name', 'profile_picture', 'is_following']
