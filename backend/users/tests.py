...
class AuthenticationTests(TestCase):
    ...
    def test_user_registration(self):
        ...
        response = self.client.post(reverse('user-register'), self.user_data, format='json')
    ...
    def test_password_reset_request(self):
        ...
        response = self.client.post(reverse('password-reset'), reset_data, format='json')
...
class UserManagementTests(TestCase):
    ...
    def test_user_list_admin_only(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data['results']), 0)  # Regular users get empty results
