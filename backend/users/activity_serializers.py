...
class UserActivitySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserActivity
        fields = [
            'id', 'user_email', 'activity_type', 'activity_type_display',
            'content_type', 'object_id', 'metadata', 'ip_address',
...
class UserActivityAggregationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'total_activities', 'logins', 'posts_created',
            'comments_created', 'likes_received', 'followers_gained',
...
class UserSessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'country', 'city', 'is_active', 'created_at', 'last_activity'
        ]
        read_only_fields = ['id', 'user_email', 'session_key', 'created_at', 'last_activity']
