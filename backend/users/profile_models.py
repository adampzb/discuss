...
class UserProfile(models.Model):
    ...
    github_username = models.CharField(
        _("GitHub username"), max_length=100, blank=True, null=True
    )
    twitter_username = models.CharField(
        _("Twitter username"), max_length=100, blank=True, null=True
    )
    linkedin_username = models.CharField(
        _("LinkedIn username"), max_length=100, blank=True, null=True
    )
    ...
    profile_background = models.ImageField(
        _("profile background"), upload_to="profile_backgrounds/", blank=True, null=True
    )
