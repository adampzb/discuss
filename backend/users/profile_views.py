...
from .profile_serializers import UserProfileSerializer, FollowSerializer, BlockSerializer, UserSearchSerializer
        ...
        if user_id:
            ...
            try:
                ...
                if profile.privacy_setting == 'public':
                    return profile
                elif profile.privacy_setting == 'friends' and profile.is_following(self.request.user):
                    return profile
                else:
                    return Response(
